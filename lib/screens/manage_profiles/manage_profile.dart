...
class _MyProfileState extends State<MyProfile> {
  ...
  List<Widget> profileSections() {
    return [
      MyProfileListData(
              title: AppLocalizations.of(context)!.public_profile_about_user,
          ...
          .getWidget(context),
      MyProfileListData(
              title: AppLocalizations.of(context)!.public_profile_basic_info,
      ...
      if (settingIsActive("member_education_section", "on"))
        MyProfileListData(
                title: AppLocalizations.of(context)!.public_profile_edu_details,
      ...
      if (settingIsActive("member_career_section", "on"))
        MyProfileListData(
                title: AppLocalizations.of(context)!.manage_profile_career_info,
                link: const CareerInfo(),
                icon: 'assets/icon/icon_educationCareer.png',
                pp: const PP_CareerInfo(),
                percentage: PercentageCalculator(
                        data: store
                            .state.manageProfileCombineState!.careerState!.list)
                    .getCareerPercentage())
            .getWidget(context),
      ...
      if (settingIsActive("member_language_section", "on"))
        MyProfileListData(
                title: AppLocalizations.of(context)!.public_profile_Lang,
                link: const Language(),
      ...
      if (settingIsActive("member_life_style_section", "on"))
        MyProfileListData(
                title: AppLocalizations.of(context)!.public_profile_life_style,
      ...
      if (settingIsActive("member_family_information_section", "on"))
        MyProfileListData(
                title: AppLocalizations.of(context)!.manage_profile_family_info,
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputStyle.inputDecoration_text_field(
              hint: AppLocalizations.of(context)!.manage_profile_general_req),
        ),
        const SizedBox(
          height: 20,
        ),
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputStyle.inputDecoration_text_field(
              hint: AppLocalizations.of(context)!.manage_profile_min_height),
        ),
        Const.height20,
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputStyle.inputDecoration_text_field(
            hint: AppLocalizations.of(context)!.manage_profile_max_weight,
          ),
        ),
        const SizedBox(
          height: 20,
            ...
            children: [
              ...
              SizedBox(
                ...
                child: DropdownButtonFormField<DDown>(
                  ...
                  decoration: InputStyle.inputDecoration_text_field(
                      hint: AppLocalizations.of(context)!.select_1,
                      suffixIcon: const Icon(Icons.keyboard_arrow_down)),
                  items: state.manageProfileCombineState!
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputStyle.inputDecoration_text_field(
            hint: AppLocalizations.of(context)!.manage_profile_education,
          ),
        ),
        const SizedBox(
          height: 20,
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputStyle.inputDecoration_text_field(
              hint: AppLocalizations.of(context)!.manage_profile_profession),
        ),
        const SizedBox(
          height: 20,
        ),
        ...
        Expanded(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputStyle.inputDecoration_text_field(
                  hint: AppLocalizations.of(context)!.manage_profile_body_type),
            )
          ],
        ))
      ],
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputStyle.inputDecoration_text_field(
              hint: AppLocalizations.of(context)!.manage_profile_complexion),
        ),
